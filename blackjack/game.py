...
text_1 = font.render("PLAY",True,(255,255,255))
...
text_2 = font.render("SETUP",True,(255,255,255))
...
text_3 = font.render("EXIT",True,(255,255,255))
...
while running:
    ...
    color_button_1 = gray_1
    color_button_2 = gray_1
    color_button_3 = gray_1
    ...
    if button_1_rect.collidepoint(pygame.mouse.get_pos()):
        pygame.draw.rect(screen, gray_1, button_1_rect)
    else:
        pygame.draw.rect(screen, gray_2, button_1_rect)
    if button_2_rect.collidepoint(pygame.mouse.get_pos()):
        pygame.draw.rect(screen, gray_1, button_2_rect)
    else:
        pygame.draw.rect(screen, gray_2, button_2_rect)        
    if button_3_rect.collidepoint(pygame.mouse.get_pos()):
        pygame.draw.rect(screen, gray_1, button_3_rect)
    else:
        pygame.draw.rect(screen, gray_2, button_3_rect)
